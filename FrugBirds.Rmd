...
```{r}
library(glmmTMB)
m6<- glmmTMB(Frugivory~scale(Beak_Width, center = T) + scale(KippsD, center=T) + scale(Centre_Lat,center=T) + (1|Genus), data=Frug_db, family="nbinom1")
summary(m6)
performance::compare_performance(m5,m6)
```
